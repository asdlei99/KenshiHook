...
public:
	Text(const char* text, float posX, float posY, int fontIndex, DirectX::SpriteFont* font);
	...
	static DirectX::XMFLOAT2 MeasureTextSize(const char* text, DirectX::SpriteFont* font);
};